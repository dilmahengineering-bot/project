...
SCHEDULING:
Est. End Date: {{estimated_delivery_date}}
Quantity: {{quantity}}
...
PR #: {{pr_number}}
PO #: {{po_number}}
Delivery Date: {{estimated_delivery_date}}

MANUFACTURING SEQUENCE:
{{manufacturing_orders}}

Generated by TaskFlow CNC System
Generated Date: {{generated_date}}`;

        const variables = JSON.stringify([
          'job_card_number', 'job_name', 'job_date', 'part_number', 'item_code',
          'drawing_number', 'machine_name', 'client_name', 'priority', 'manufacturing_type',
          'estimated_delivery_date', 'quantity', 'material', 'dimension', 'tolerance',
          'surface_finish', 'pr_number', 'po_number', 'manufacturing_orders', 'generated_date'
        ]);

        await db.query(
          'INSERT INTO machine_job_card_templates (name, template_content, variables) VALUES ($1, $2, $3)',
